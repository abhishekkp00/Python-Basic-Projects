...
result_label.grid(row=0, column=0, columnspan=5,pady=(50,40), sticky='w')
...
btn_mul = Button(root, text="x", fg="white", bg="green", width= 5, height= 2, command=lambda: get_operator("*"))
btn_mul.grid(row=4, column=0)
btn_mul.grid(row=3, column=3)
btn_mul.config(font=('Verdana', 14, "bold"))

btn_div = Button(root, text="/", fg="white", bg="green", width= 5, height= 2, command=lambda: get_digit("/"))
btn_div.grid(row=4, column=1)
btn_div.grid(row=4, column=3)
btn_div.config(font=('Verdana', 14, "bold"))

btn_eq = Button(root, text="=", fg="white", bg="green", width= 5, height= 2, command=get_result)
btn_eq.grid(row=4, column=2)
btn_eq.config(font=('Verdana', 14, "bold"))

btn_zero = Button(root, text="0", fg="white", bg="green", width= 5, height= 2, command=lambda: get_digit(0))
btn_zero.grid(row=4, column=1)
btn_zero.config(font=('Verdana', 14, "bold"))

btn_clr = Button(root, text="C", fg="white", bg="green", width= 5, height= 2, command=lambda: clear())
